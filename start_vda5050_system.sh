...
echo ""
echo -e "${PURPLE}[AGV] 真实AGV配置要求：${NC}"
...
echo ""
echo -e "${CYAN}[测试] 如需测试虚拟AGV，请运行: ./test/test_start_vda5050_system.sh${NC}"
echo ""
...
echo ""
echo -e "${GREEN}[成功] 系统已成功启动并在后台运行！${NC}"
echo ""
